      ...
      <div className="mx-auto max-w-450 section-x py-10 text-center text-[0.95rem] text-primary">
        <Animated show={show} delay={120}>
          <div className="flex flex-wrap justify-center gap-x-6 gap-y-3 underline mb-6">
            <a href="/privacy-policy" className="hover:underline text-black text-[calc(0.2vw+0.8rem)]">Privacy & Cookies Policy</a>
            <a href="/good-faith-estimate" className="hover:underline text-black text-[calc(0.2vw+0.8rem)]">Good Faith Estimate</a>
            <a href="/terms-conditions" className="hover:underline text-black text-[calc(0.2vw+0.8rem)]">Website Terms & Conditions</a>
            <a href="/disclaimer" className="hover:underline text-black text-[calc(0.2vw+0.8rem)]">Disclaimer</a>
          </div>
